		...
		<div class="col-md-12 m-t-30">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('addBannerProcess')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="{{ $errors->has('text1') ? ' has-error' : '' }}">
                            <div class="col-md-4">
                            	<label for="text1" class="control-label">Text1</label>
                                <input id="text1" type="text" class="form-control" name="text1" value="{{ old('text1') }}" placeholder='Enter Text... '  autofocus>
                        ...
                        <div class="{{ $errors->has('text2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="text2" type="text" class="form-control" name="text2" value="{{ old('text2') }}" placeholder='Enter Text...'  autofocus>
                        ...
                        <div class="{{ $errors->has('text3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="text3" type="text" class="form-control" name="text3" value="{{ old('text1') }}" placeholder='Enter Text...'  autofocus>
                        ...
                        <div class="{{ $errors->has('type') ? ' has-error' : '' }}">
                            <div class="col-md-4">
                                ...
                                <input id="type" type="text" class="form-control" name="type" value="{{old('type')}}" placeholder='Enter Type...' >
