  ...
  <section class="content-section specific-module">
    <div class="col-lg-8  div-center div-center2">
      <div class="specific-content">
        ...
        <h1 class="title-h wow fadeInDown"> Collections </h1>
          ...
          <div class="carousel slide wow fadeIn" data-ride="carousel" id="quote-carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                <div class="row">
                  <div class="col-sm-9 col-center text-center"> <img class="img-circle" src="public/assets/images/testimonial-be.jpg" alt="" title=""> </div>
                  <div class="col-sm-9 col-center">
                    <div class="clients text-center"><img src="public/assets/images/coma.jpg" class="coma1" alt="" title="">  Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo-Text seit 1500, als ein unbekannter Schriftsteller  <img src="public/assets/images/coma2.jpg" class="coma12" alt="" title=""></div>
              ...
              <div class="item">
                <div class="row">
                  <div class="col-sm-9 col-center text-center"> <img class="img-circle" src="public/assets/images/testimonial-be2.jpg" alt="" title=""> </div>
                  <div class="col-sm-9 col-center">
                    <div class="clients text-center"><img src="public/assets/images/coma.jpg" class="coma1" alt="" title="">  Lorem Ipsum ist ein einfacher Demo-Text für die Print- und Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo-Text seit 1500, als ein unbekannter Schriftsteller   <img src="public/assets/images/coma2.jpg" class="coma12" alt="" title=""></div>
                    <p class="clients-name"> - Clients name - </p>
                  </div>
